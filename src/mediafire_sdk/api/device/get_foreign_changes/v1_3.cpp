...
namespace v1_3 = mf::api::device::get_foreign_changes::v1_3;
...
const std::string api_path("/api/1.3/device/get_foreign_changes");
...
Request::Request(
    ...
    impl_(new Impl(revision, contact_key))
{
}
