...
namespace v1_0 = mf::api::user::get_action_token::v1_0;


namespace {
std::string AsString(const v1_0::Type & value)
{
    if (value == v1_0::Type::Image)
        return "image";
    if (value == v1_0::Type::Upload)
        return "upload";
...
const std::string api_path("/api/1.0/user/get_action_token");
