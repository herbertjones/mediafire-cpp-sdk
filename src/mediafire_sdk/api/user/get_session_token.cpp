/**
 * @file get_session_token.cpp
 * @author Herbert Jones
 *
 * @copyright Copyright 2014 Mediafire
 */
#include "get_session_token.hpp"
...
namespace v0 = mf::api::user::get_session_token::v0;
...
std::string AsString(const v0::TokenVersion & value)
{
    if (value == v0::TV_One)
        return "1";
    if (value == v0::TV_Two)
...
std::string v0::Request::Url(std::string hostname) const
{
    ...
    std::string url;
    url = "https://" + hostname + "/api/user/get_session_token.php";
