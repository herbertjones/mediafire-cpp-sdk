...
namespace v0 = mf::api::folder::get_content::v0;
...
std::string AsString(const v0::OrderBy & value)
{
    if (value == v0::OrderBy::Name)
        return "name";
    if (value == v0::OrderBy::Created)
        return "created";
    if (value == v0::OrderBy::Size)
        return "size";
    if (value == v0::OrderBy::Downloads)
        return "downloads";
    return mf::utils::to_string(static_cast<uint32_t>(value));
}
std::string AsString(const v0::OrderDirection & value)
{
    if (value == v0::OrderDirection::Ascending)
        return "asc";
    if (value == v0::OrderDirection::Descending)
        return "desc";
    return mf::utils::to_string(static_cast<uint32_t>(value));
}
std::string AsString(const v0::Details & value)
{
    if (value == v0::Details::NoDetails)
        return "no";
    if (value == v0::Details::PopulateDetails)
        return "yes";
...
const std::string api_path("/api/folder/get_content");
