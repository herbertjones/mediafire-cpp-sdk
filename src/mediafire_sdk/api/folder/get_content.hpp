 ...
 * @brief API request: /api/1.2/folder/get_content
 *
...
/** API path "/api/1.2/folder/get_content" */
namespace v1_2 {

namespace v1_0 = mf::api::folder::get_content::v1_0;

using v1_0::ContentType;
using v1_0::OrderBy;
using v1_0::OrderDirection;
using v1_0::Details;
using v1_0::Privacy;
using v1_0::FileDrop;
using v1_0::PasswordProtected;
using v1_0::SharedByUser;
using v1_0::SharedWithUser;
...
public:
    ...
    /** API response field "response.folder_content.more_chunks" */
