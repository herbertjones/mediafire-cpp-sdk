...
namespace v1_3 = mf::api::file::update::v1_3;


namespace {
std::string AsString(const v1_3::Privacy & value)
{
    if (value == v1_3::Privacy::Public)
        return "public";
    if (value == v1_3::Privacy::Private)
        return "private";
...
const std::string api_path("/api/1.3/file/update");
