...
namespace v1_3 = mf::api::file::create::v1_3;


namespace {
std::string AsString(const v1_3::FileType & value)
{
    if (value == v1_3::FileType::Default)
        return "";
    if (value == v1_3::FileType::Text)
        return "text";
...
const std::string api_path("/api/1.3/file/create");
