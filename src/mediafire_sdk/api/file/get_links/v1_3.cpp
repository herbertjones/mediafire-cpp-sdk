...
namespace v1_3 = mf::api::file::get_links::v1_3;


namespace {
std::string AsString(const v1_3::LinkType & value)
{
    if (value == v1_3::LinkType::View)
        return "view";
    if (value == v1_3::LinkType::Edit)
        return "edit";
    if (value == v1_3::LinkType::Listen)
        return "listen";
    if (value == v1_3::LinkType::Watch)
        return "watch";
    if (value == v1_3::LinkType::NormalDownload)
        return "normal_download";
    if (value == v1_3::LinkType::DirectDownload)
        return "direct_download";
    if (value == v1_3::LinkType::OneTimeDownload)
...
#   define return_error(error_type, error_message)                             \
    ...
    // create_content_parse_single optional no default
    {
        ...
        if ( GetIfExists(
                pt,
                "one_time.download_error_message",
                &optarg) )
        {
...
const std::string api_path("/api/1.3/file/get_links");
